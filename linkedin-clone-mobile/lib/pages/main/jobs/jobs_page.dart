                  ...
                  child: Column(
                    ...
                    children: [
                      const Row(
                        ...
                        children: [
                          Text("Web Developer", maxLines: 2,overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                          Icon(Icons.bookmark_border, size: 30, color: linkedInMediumGrey86888A,)
                        ],
                      ),
                      const SizedBox(height: 2,),
                      const Text("ABC Company", style: TextStyle(fontSize: 15),),
